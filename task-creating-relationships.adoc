...
+
This setting is available only when creating a sync relationship and when you sync from an S3 bucket or Google Cloud Storage to S3, Google Cloud Storage, Azure Blob storage, StorageGRID, or IBM Storage.
+
