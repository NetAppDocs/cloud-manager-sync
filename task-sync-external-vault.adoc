---
sidebar: sidebar
permalink: task-sync-external-vault.html
...
link:task-sync-installing-gcp.html#permissions-required-for-the-service-account[Learn more about GCP permission requirements for the data broker].
