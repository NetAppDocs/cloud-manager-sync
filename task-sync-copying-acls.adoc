---
sidebar: sidebar
permalink: task-sync-copying-acls.html
...
This feature works with _any_ type of data broker: the AWS, Azure, Google Cloud Platform, or on-prem data broker. The on-prem data broker can run link:task-sync-installing-linux.html[any supported operating system].
