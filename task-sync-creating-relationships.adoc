...
* https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html[Setting up and discovering Azure NetApp Files^]
...
* https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-adding-ontap-cloud.html[Adding existing Cloud Volumes ONTAP systems^]
